...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__styles_user_css__ = __webpack_require__(1);
...
__WEBPACK_IMPORTED_MODULE_1_electron__["ipcRenderer"].send('getData');
const login = JSON.parse(Object(__WEBPACK_IMPORTED_MODULE_2_fs__["readFileSync"])('../data/login.json'));
